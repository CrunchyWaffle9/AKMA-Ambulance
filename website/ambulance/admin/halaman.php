    ...
    <tbody>
        ...
        if ($katakunci != '') {
            ...
            for ($x = 0; $x < count($array_katakunci); $x++) {
                $sqlcari[] = "(nama like '%" . $array_katakunci[$x] . "%' or no_telp like '%" . $array_katakunci[$x] . "%' or keluhan like '%" . $array_katakunci[$x] . "%')";
            }
        ...
        while ($r1 = mysqli_fetch_array($q1)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="verif.php?id=<?php echo $r1['id']?>">
                    <span class="badge bg-primary text-light">Verify </span>
                    </a>
                </td>
            </tr>
            <?php
